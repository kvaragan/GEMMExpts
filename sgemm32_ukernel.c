...
#pragma message ("LIBXSMM KERNEL COMPILATION WARNING: compiling AVX2 code on AVX512 or newer architecture: " __FILE__)
  ...
  __asm__ __volatile__("movq %0, %%rsi\n\t"
                       ...
                       "vmovaps 192(%%rdx), %%ymm10\n\t"
                       "vmovaps 224(%%rdx), %%ymm11\n\t"
                       ...
                       "vmovaps %%ymm9, 160(%%rdx)\n\t"
                       "vmovaps %%ymm10, 192(%%rdx)\n\t"
                       "vmovaps %%ymm11, 224(%%rdx)\n\t"
                       "vmovaps %%ymm12, 256(%%rdx)\n\t"
                       "vmovaps %%ymm13, 288(%%rdx)\n\t"
                       ...
                       "vmovaps %%ymm12, 128(%%rdx)\n\t"
                       "vmovaps %%ymm13, 160(%%rdx)\n\t"
                       "vmovaps %%ymm14, 192(%%rdx)\n\t"
                       "vmovaps %%ymm15, 224(%%rdx)\n\t"
                       "addq $128, %%rdx\n\t"
                       "subq $3968, %%rdi\n\t"
                       "cmpq $32, %%r12\n\t"
                       "jl 1b\n\t"
